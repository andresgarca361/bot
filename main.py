...
def get_current_rsi():
    ...
    required_prices = 34
    prices = []
    start_time = time.time()  # 10:12 AM CST
    target_end_time = start_time + (required_prices * 60)  # 10:46 AM CST
    ...
    log(f"Current RSI calculated: {rsi:.2f} based on prices from 09:38 AM to 10:12 AM CST")
    return rsi
